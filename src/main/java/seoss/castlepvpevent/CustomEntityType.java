...
public class CustomEntityType<T extends EntityLiving> {
    ...
    public org.bukkit.entity.Entity spawn(Location loc) {
        ...
        Entity entity = entityType.spawnCreature(((CraftWorld)loc.getWorld()).getHandle(), null, null, null, new BlockPosition(loc.getBlockX(), loc.getBlockY(), loc.getBlockZ()), EnumMobSpawn.EVENT, true, false);
